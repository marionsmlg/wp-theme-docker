...
<main class="min-h-screen">
                    ...
                    <div class="pb-16 sm:pb-24">
                        <div class="mt-4">
                            <?php if (get_sub_field('title')) : ?>
                                <h2 class="text-2xl font-bold tracking-tight text-gray-700 sm:text-3xl"><?php the_sub_field('title'); ?></h2>
                            <?php endif; ?>
                ...
                <div class="pb-16 sm:pb-24">
                                                ...
                                                <?php while (have_rows('list')) : the_row(); ?>
                                                    <?php if (get_sub_field('element')) : ?>
                                                        <li class="flex gap-x-3">
                                                            <svg class="mt-1 h-5 w-5 flex-none text-gray-700" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                    ...
                    <?php while (have_rows('engagements_pilotage')) : the_row(); ?>
                        <div class="mx-auto mt-16 max-w-2xl sm:mt-20 lg:mt-24 lg:max-w-none">
                            <div class="mt-4 mb-10">
                                <?php if (get_sub_field('title')) : ?>
                                    <h3 class="text-xl font-bold tracking-tight text-gray-700 sm:text-2xl"><?php the_sub_field('title'); ?></h3>
                                <?php endif ?>
                                <?php if (get_sub_field('subtitle')) : ?>
                                    <p class="mt-2 text-lg leading-8 text-gray-600"><?php the_sub_field('subtitle'); ?></p>
                                <?php endif ?>
                                    ...
                                    <div class="flex flex-col">
                                        <div class="text-base font-semibold leading-7 text-gray-900">
                                            <?php if (get_sub_field('icon')) : ?>
                                                <div class="mb-6 flex h-10 w-10 items-center justify-center rounded-lg bg-gray-700">
    ...
    <div class="mx-auto max-w-7xl sm:px-6 sm:pb-32  lg:px-8">
        <div class="relative isolate overflow-hidden bg-eseisblue-50 px-6 py-24 text-center sm:shadow-2xl sm:rounded-3xl sm:px-16">
            <h2 class="mx-auto max-w-2xl text-2xl font-bold tracking-tight text-gray-700 sm:text-3xl">Prêt à optimiser votre environnement de travail et à simplifier la gestion de vos installations ? </h2>
            ...
            <div class="text-center pt-10"><a href="/contact"><button type="button" class="rounded-md bg-gray-700 px-3.5 py-2.5 text-lg font-semibold text-white shadow-sm hover:bg-eseisblue-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 z-10">Contactez-nous</button></a> </div>
        </div>
    </div>
</main>
