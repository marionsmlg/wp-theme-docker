                            ...
                            <?php while (have_rows('social_media', 'options')) : the_row(); ?>
                                <div class="flex space-x-6">
                                    <?php if (get_sub_field('facebook')) : ?>
                                        <a href="<?php the_sub_field('facebook'); ?>" class="text-gray-500 hover:text-gray-400">
                                    ...
                                    <?php if (get_sub_field('instagram')) : ?>
                                        <a href="<?php the_sub_field('instagram'); ?>" class="text-gray-500 hover:text-gray-400">
                                    ...
                                    <?php if (get_sub_field('x')) : ?>
                                        <a href="<?php the_sub_field('x'); ?>" class="text-gray-500 hover:text-gray-400">
                                    ...
                                    <?php if (get_sub_field('github')) : ?>
                                        <a href="<?php the_sub_field('github'); ?>" class="text-gray-500 hover:text-gray-400">
                                    ...
                                    <?php if (get_sub_field('youtube')) : ?>
                                        <a href="<?php the_sub_field('youtube'); ?>" class="text-gray-500 hover:text-gray-400">
