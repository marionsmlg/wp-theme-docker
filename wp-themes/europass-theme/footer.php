<footer class="bg-maincolor-100" aria-labelledby="footer-heading">
    ...
    <div class="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
        <div class="xl:grid xl:grid-cols-3 xl:gap-8">
                ...
                <?php while (have_rows('social_media', 'options')) : the_row(); ?>
                    <div class="flex space-x-6">
                        <?php if (get_sub_field('linkedin')) : ?>
                            <a href="<?php the_sub_field('linkedin'); ?>" target="_blank" class="text-gray-500 hover:text-gray-400">
            ...
            <div class="mt-16 md:grid md:grid-cols-3 gap-8 xl:col-span-2 xl:mt-0">
                ...
                ?>
                    <div>
                        <h3 class="text-sm font-semibold leading-6 text-secondarycolor uppercase">Navigation</h3>
                ...
                ?>
                    <div class="mt-10 md:mt-0">
                        <h3 class="text-sm font-semibold leading-6 text-secondarycolor uppercase">Légal</h3>
                        <ul role="list" class="mt-6 space-y-4">
                            <?php foreach ($menuitems as $item) : ?>
                                <li>
                                    <a href="<?= esc_url($item->url) ?>" class="text-sm leading-6 text-secondarycolor-300 hover:text-secondarycolor-100"><?= esc_html($item->title) ?></a>
                ...
                <?php while (have_rows('contacts', 'options')) : the_row(); ?>
                    <div class="mt-10 md:mt-0">
                        <h3 class="text-sm font-semibold leading-6 text-secondarycolor uppercase">CONTACT</h3>
                        ...
                        <ul role="list" class="mt-6 space-y-4">
                            ...
                            <?php if (get_sub_field('phone_number')) : ?>
                                <li>
                                    <a class="text-sm font-medium leading-6 text-secondarycolor-300" href="tel:<?php the_sub_field('phone_number'); ?>">Tel : <span class="text-maincolor hover:text-maincolor-300"><?php the_sub_field('phone_number'); ?></span></a>
                                </li>
                            <?php endif ?>
