        ...
        <div class="mx-auto grid max-w-7xl grid-cols-1 lg:grid-cols-2">
            <div class="relative px-6 pb-20 pt-4 sm:pt-20 lg:static lg:px-8 border-r">
                <div class="mx-auto max-w-xl lg:mx-0 lg:max-w-lg">
                    <?php if (get_field('title')) : ?>
                        <h2 class="text-3xl font-bold tracking-tight text-blue-900"><?php echo esc_html(get_field('title')); ?></h2>
                    <?php endif; ?>
                        ...
                        <dl class="mt-10 space-y-4 text-base leading-7 text-gray-600">
                            <div class="flex gap-x-4">
                                <dt class="flex-none">
                                    ...
                                    <svg class="h-7 w-6 text-blue-900" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
                            ...
                            <?php if (get_sub_field('linkedin')) : ?>
                                <div class="flex gap-x-4">
                                    <dt class="flex-none">
                                        <a href="<?php the_sub_field('linkedin'); ?>" class="text-gray-400 hover:text-gray-500">
            ...
            <form method="POST" class="px-6 pb-24 pt-4 sm:pt-20 sm:pb-32 lg:px-8">
                <div class="mx-auto max-w-xl lg:mr-0 lg:max-w-lg">
                    <h2 class="text-3xl font-bold tracking-tight text-blue-900">Formulaire de contact</h2>
