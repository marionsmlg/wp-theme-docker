                                ...
                                <div class="flex flex-col items-start justify-between border border-2 rounded-2xl bg-gray-100 pb-4 shadow-lg">
                                    <?php if (get_sub_field('illustration')) : ?>
                                        <div class="relative w-full">
                                            <img src="<?php the_sub_field('illustration'); ?>" alt="" class="aspect-[16/9] w-full rounded-t-2xl bg-gray-100 object-cover sm:aspect-[2/1] lg:aspect-[3/2]">
                                    ...
                                    <div class="w-full h-full p-6">
                                        <div class="group relative flex flex-col items-center justify-center">
                                            ...
                                            <?php endif; ?>
                                            <ul class="mt-5 font-semibold leading-6 text-gray-600 list-disc list-inside space-y-2">
                                            ...
                                            <ul class="space-y-4">
                                                <?php while (have_rows('list')) : the_row(); ?>
                                                    <?php if (get_sub_field('element')) : ?>
                                                        <li class="flex items-center"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class=" min-w-fit w-4 h-4 mr-2 text-eseisblue-500">
                                                                <path stroke-linecap="round" stroke-linejoin="round" d="M13.5 4.5 21 12m0 0-7.5 7.5M21 12H3" />
                                                            </svg> <span><?php the_sub_field('element'); ?></span>
                                                        </li>
                                                    <?php endif ?>
                                                <?php endwhile; ?>
                                            </ul>
