...
<div class="mt-16  min-h-screen ">
        ...
        <div class="flex px-4 pt-8 pb-10 lg:px-8"><a class="group flex font-semibold text-sm leading-6 text-slate-400 hover:text-slate-600 " href="<?= get_post_type_archive_link('post') ?>"><svg viewBox="0 -9 3 24" class="overflow-visible mr-3 text-slate-400 w-auto h-6 group-hover:text-slate-600">
