...
<main class="mt-16 min-h-screen">
    ...
    <div aria-hidden="true" class="relative">
        <img src="https://eseisdotfr.wpcomstaging.com/wp-content/uploads/2024/01/absolutvision-WYd_PkCa1BY-unsplash.jpg" alt="" class="h-40 md:h-56 w-full object-cover object-center">
            ...
            <div class="bg-white py-14 md:py-32">
                <div class="mx-auto max-w-7xl px-6 lg:px-8">
                    <div class="mx-auto max-w-2xl lg:max-w-4xl">
                        <h2 class="text-2xl font-bold tracking-tight text-eseisblue-500 sm:text-3xl">Restez à la pointe de l'actualité avec ESEÏS</h2>
